...
const FAQPage = () => {
  const faqs: FAQItem[] = [
    ...
    { category: "General", question: "How long have you been in business?", answer: "Sky Vision Multimedia has been Mumbai's trusted AV rental partner for over 25 years. We've powered 10 Lakh+ events ranging from intimate birthday parties to large-scale corporate conferences and concerts." },
