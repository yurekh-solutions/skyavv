...
const FAQPage = () => {
  const faqs: FAQItem[] = [
    { category: "General", question: "What areas do you serve?", answer: "We provide AV equipment rental services across Mumbai, Navi Mumbai, Thane, Pune, Lonavala, Surat, and Goa. We offer included delivery and setup within Mumbai city limits and competitive rates for outstation events." },
    { category: "General", question: "How long have you been in business?", answer: "Sky Vision Multimedia has been Mumbai's trusted AV rental partner for over 25 years. We've powered 5 Lakh+ events ranging from intimate birthday parties to large-scale corporate conferences and concerts." },
    ...
    { category: "Booking", question: "How far in advance should I book equipment?", answer: "We recommend booking at least 7-10 days in advance for peak season (October-March) and 3-5 days for regular bookings. However, we also accommodate last-minute bookings subject to availability. Call us at +91 86559 73366 / +91 99201 58955 for urgent requirements." },
    ...
    { category: "Delivery", question: "Is delivery included in the rental price?", answer: "Yes! Delivery and setup are included within Mumbai city limits. For events in Navi Mumbai, Thane, and Pune, nominal transportation charges apply. Outstation deliveries to Lonavala, Surat, and Goa are charged based on distance." },
