...
const Terms = () => {
  const sections = [
    ...
    { title: "Delivery and Setup", content: "Free delivery and setup are included within Mumbai city limits. For events outside Mumbai, nominal transportation charges apply. Setup is performed by our certified technicians. The client must ensure the venue is accessible and ready for setup at the agreed time. Any delays caused by the venue or client may result in additional labor charges." },
    ...
    { title: "Contact Information", content: "For any questions about these Terms and Conditions, please contact: Sky Vision Multimedia, Phone: +91 86559 73366, Email: sky.av.rentals@gmail.com, Address: Room No 951, Nayagaon Near Maharashtra Hotel, Laxman Mahatre Road, Dahisar West, Mumbai - 400068." },
  ];
